					...
					if (ch == 1) {
						...
						while (true) {
							...
							if (space.isSpaceAvailableVisitor().equals("Yes")) {
								...
								System.out.println("Enter the value of hour between 9-20 inclusive:\n"); //assuming visitors are allowed only from 9am-8pm
								String hr=sc.next();
								System.out.println("Enter the value of minutes between 00-60 inclusive:\n");
								String mins=sc.next();
